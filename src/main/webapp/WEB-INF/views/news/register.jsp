...
<c:set var="pageTitle" value="주간 뉴스 기사 등록" />
...
<div class="container py-5">
  <div class="card shadow-lg border-0 rounded-3 mx-auto" style="max-width: 600px;">
    <div class="card-header text-white text-center py-3 rounded-top-3" style="background-color: #2D4470;">
      <h4 class="mb-0 fw-bold">주간 뉴스 기사 등록</h4>
    </div>

    <div class="card-body p-4">
      <form action="${pageContext.request.contextPath}/news/register" method="post">
        ...
        <div class="mb-4">
          ...
          <input type="text" name="title" id="newsTitle" class="form-control form-control-lg" placeholder="주간 뉴스 기사 제목을 입력하세요" required>
        </div>

        <div class="mb-4">
          <label for="newsWriter" class="form-label fw-bold text-dark">작성자</label>
          <input type="text" name="writer" id="newsWriter" class="form-control" value="관리자" required readonly>
        ...
        <div class="mb-4">
          ...
          <textarea name="content" id="newsContent" rows="10" class="form-control" placeholder="주간 뉴스 기사 내용을 상세히 입력하세요" required></textarea>
        </div>
